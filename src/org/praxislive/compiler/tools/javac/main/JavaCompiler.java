...
import static org.praxislive.compiler.tools.javac.util.ListBuffer.lb;
...
//      System.err.println("completing " + c);//DEBUG
   ...
   public List<JCCompilationUnit> parseFiles(Iterable<JavaFileObject> fileObjects) {
    ...
    public static void enableLogging() {
        Logger logger = Logger.getLogger(org.praxislive.compiler.tools.javac.Main.class.getPackage().getName());
