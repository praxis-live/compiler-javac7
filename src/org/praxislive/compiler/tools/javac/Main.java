...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
      if (args.length > 0 && args[0].equals("-Xjdb")) {
        ...
        Class<?> c = Class.forName("org.praxislive.compiler.tools.example.debug.tty.TTY");
        Method method = c.getDeclaredMethod ("main", new Class<?>[] {args.getClass()});
        method.setAccessible(true);
        System.arraycopy(args, 1, newargs, 3, args.length - 1);
        newargs[0] = "-connect";
        newargs[1] = "org.praxislive.compiler.jdi.CommandLineLaunch:options=-esa -ea:org.praxislive.compiler.tools...";
        newargs[2] = "org.praxislive.compiler.tools.javac.Main";
