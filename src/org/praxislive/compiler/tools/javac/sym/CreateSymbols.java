 ...
 */
@SupportedOptions({"org.praxislive.compiler.tools.javac.sym.Jar","org.praxislive.compiler.tools.javac.sym.Dest"})
...
public class CreateSymbols extends AbstractProcessor {
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = processingEnv.getOptions().get("org.praxislive.compiler.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Aorg.praxislive.compiler.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = processingEnv.getOptions().get("org.praxislive.compiler.tools.javac.sym.Dest");
        if (destName == null)
